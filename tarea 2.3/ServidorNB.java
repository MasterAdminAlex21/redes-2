...
public class ServidorNB {
    public static void main(String[] args){
        if(args.length<1){
            System.err.println("Uso: java ServidorNB <num clientes>");
            System.exit(0);
        }
        ...
        try{
            int max=Integer.parseInt(args[0]),clicon=0;
            String EECO="";
            int pto=9999;
            ...
            while(true){
                ...
                while(it.hasNext()){
                    ...
                    if(k.isAcceptable()){
                        if(clicon>=max){
                            System.out.println("Ya no hay mas espacio para mas clientes");
                        ...
                        if(k.isWritable()){
                            ...
                            ByteBuffer bb = ByteBuffer.wrap("Conexion rechazada".getBytes());
                            ch.write(bb);
